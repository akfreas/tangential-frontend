...
import { extractFromJiraAuth, fetchLatestProjectReportsWithEpics, jsonLog,  } from '@akfreas/tangential-core';
...
export default async function ProgramsPage({}) {
  try {
    ...
    return (
        <Card>
          <ProjectHeader/>
          {!needsFirstAnalysis && <ProjectTable reports={JSON.parse(JSON.stringify(reports))} />}
          {needsFirstAnalysis && (
